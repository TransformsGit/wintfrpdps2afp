...
echo %gs%
set folderIN=E:\OutputTransformPS2AFP\win\output\out_PDF\TestFiles\
echo %folderIN%
...
echo Copy.... e:\OutputTransformPS2AFP\win\output\out_PDF\TestFiles\*.tif E:\OutputTransformPS2AFP\win\output\out_TIFF\MasterFiles\
xcopy /y /s /d  e:\OutputTransformPS2AFP\win\output\out_PDF\TestFiles\*.tif E:\OutputTransformPS2AFP\win\output\out_TIFF\MasterFiles\ >> C:\Users\Administrator\Transforms\TestPS2AFP\Log\win\all_PDF2TIFF_itm-driveraaaa.log 2>&1
