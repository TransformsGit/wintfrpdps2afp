...
echo Copy.... e:\OutputTransformPS2AFP\win\output\out_AFP\TestFiles\PDF\*.pdf e:\OutputTransformPS2AFP\win\output\out_PDF\TestFiles\PDF\  
xcopy /y /s /d  e:\OutputTransformPS2AFP\win\output\out_AFP\TestFiles\PDF\*.pdf e:\OutputTransformPS2AFP\win\output\out_PDF\TestFiles\PDF\ >> C:\Users\Administrator\Transforms\TestPS2AFP\Log\win\allcopy_afp2pdf_itm-driver.log 2>&1
